...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Request', fields ['priority']
        db.create_index('contact_request', ['priority'])


    def backwards(self, orm):
        # Removing index on 'Request', fields ['priority']
        db.delete_index('contact_request', ['priority'])
    ...
    models = {
        ...
        'contact.request': {
            'Meta': {'ordering': "['-priority', '-created_at']", 'object_name': 'Request'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
